...
const SvgMessagesBubbleSquareStar = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".messages-bubble-square-star_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="messages-bubble-square-star_svg__a"
      d="M9.5 14.5h-1l-4 4v-4h-3a1 1 0 01-1-1v-12a1 1 0 011-1h19a1 1 0 011 1V11"
    />
  );
