...
const SvgAudioFileDisable = (props) =>
  React.createElement(
    SvgIcon,
    props,
    <defs>
      <style>
        {
          ".audio-file-disable_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
      className="audio-file-disable_svg__a"
    ...
    />,
    <circle className="audio-file-disable_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="audio-file-disable_svg__a"
...
export default SvgAudioFileDisable;
