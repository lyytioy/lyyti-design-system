...
const SvgAudioFileDownload = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".audio-file-download_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="audio-file-download_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="audio-file-download_svg__a"
