...
const SvgEarpodsRemove = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".earpods-remove_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <circle className="earpods-remove_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="earpods-remove_svg__a"
      d="M19.621 15.379l-4.242 4.242M19.621 19.621l-4.242-4.242M6 8.5A1.5 1.5 0 017.5 10M3.25 5.25A.25.25 0 113 5.5a.25.25 0 01.25-.25"
    />,
    <path
      className="earpods-remove_svg__a"
