...
const SvgPhoneActionRecord = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".phone-action-record_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="phone-action-record_svg__a" cx={12} cy={12} r={3.5} />,
    <path
      className="phone-action-record_svg__a"
