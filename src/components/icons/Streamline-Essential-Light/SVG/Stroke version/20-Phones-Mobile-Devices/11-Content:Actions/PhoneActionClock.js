...
const SvgPhoneActionClock = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".phone-action-clock_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="phone-action-clock_svg__a"
      d="M18.5 19.5h-13M18.5 4.5h-13M10.5 2.5h3M14.5 12.5h-3v-5"
    />
  );
