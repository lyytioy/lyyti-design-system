...
const SvgServerDisable = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".server-disable_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="server-disable_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path className="server-disable_svg__a" d="M13.258 21.742l8.485-8.485" />
  );
