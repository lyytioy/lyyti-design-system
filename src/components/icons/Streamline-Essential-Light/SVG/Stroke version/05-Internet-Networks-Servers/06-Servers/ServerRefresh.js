...
const SvgServerRefresh = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".server-refresh_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="server-refresh_svg__a"
      d="M4.75 15.25a.25.25 0 10.25.25.25.25 0 00-.25-.25M8.25 15.25a.25.25 0 10.25.25.25.25 0 00-.25-.25M19 15.5h4.5V11M23.158 15.5a6 6 0 10-.968 5.742"
    />
  );
