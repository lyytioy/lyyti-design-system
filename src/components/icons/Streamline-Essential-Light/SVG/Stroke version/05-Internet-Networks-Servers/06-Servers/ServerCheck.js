...
const SvgServerCheck = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".server-check_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="server-check_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="server-check_svg__a"
      d="M20.174 15.756l-2.905 3.874a.75.75 0 01-1.13.08l-1.5-1.5"
    />
  );
