...
const SvgServerSubtract = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".server-subtract_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="server-subtract_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path className="server-subtract_svg__a" d="M20.5 17.5h-6" />
  );
