...
const SvgServerClock1 = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".server-clock-1_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <circle className="server-clock-1_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="server-clock-1_svg__a"
      d="M19.5 17.5h-2v-3M5.5 20.5h3M8.501 15.5v5M3.25 20a.25.25 0 10.25.25.25.25 0 00-.25-.25M.75 20a.25.25 0 10.25.25.25.25 0 00-.25-.25M4.25 12.75a.25.25 0 10.25.25.25.25 0 00-.25-.25M6.75 12.75A.25.25 0 107 13a.25.25 0 00-.25-.25"
    />,
    <path
      className="server-clock-1_svg__a"
