...
const SvgNetworkAdd = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".network-add_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="network-add_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path className="network-add_svg__a" d="M17.5 14.5v6M20.5 17.5h-6" />
  );
