...
const SvgCloudDisable = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".cloud-disable_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="cloud-disable_svg__a" cx={12} cy={16.5} r={6} />,
    <path className="cloud-disable_svg__a" d="M7.758 20.742l8.485-8.485" />
  );
