...
const SvgCloudSubtract = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".cloud-subtract_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="cloud-subtract_svg__a" cx={12} cy={16.5} r={6} />,
    <path className="cloud-subtract_svg__a" d="M15 16.5H9" />
  );
