...
const SvgCloudSmartphoneUpload = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".cloud-smartphone-upload_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="cloud-smartphone-upload_svg__a"
      d="M12 19.75a.25.25 0 10.25.25.25.25 0 00-.25-.25M12 9.5V4M14.5 6.5L12 4 9.5 6.5"
    />
  );
