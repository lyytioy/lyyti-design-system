...
const SvgWifiSubtract = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".wifi-subtract_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="wifi-subtract_svg__a" cx={17.359} cy={17.5} r={6} />,
    <path className="wifi-subtract_svg__a" d="M20.359 17.5h-6" />
  );
