...
const SvgZoomOutPage = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".zoom-out-page_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="zoom-out-page_svg__a" cx={14.3} cy={14.299} r={6.133} />,
    <path
      className="zoom-out-page_svg__a"
      d="M12.3 14.299h4M18.637 18.636l4.863 4.863"
    />
  );
