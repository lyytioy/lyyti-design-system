...
const SvgTagsRemove = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".tags-remove_svg__a{fill:none;stroke:currentColor;stroke-linejoin:round;stroke-linecap:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="tags-remove_svg__a" cx={15.542} cy={3.998} r={1.5} />,
    <circle
      cx={17.042}
      cy={17.498}
      r={6}
    ...
    <path
      className="tags-remove_svg__a"
      d="M19.163 15.377l-4.242 4.242M19.163 19.619l-4.242-4.242"
    />
  );
