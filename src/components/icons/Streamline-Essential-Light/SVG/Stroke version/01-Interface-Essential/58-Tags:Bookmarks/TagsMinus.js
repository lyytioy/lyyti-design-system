...
const SvgTagsMinus = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".tags-minus_svg__a{fill:none;stroke:currentColor;stroke-linejoin:round;stroke-linecap:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="tags-minus_svg__a" cx={15.542} cy={3.998} r={1.5} />,
    <circle
      cx={17.042}
      cy={17.498}
      r={6}
    ...
    />,
    <path className="tags-minus_svg__a" d="M20.042 17.498h-6" />
  );
