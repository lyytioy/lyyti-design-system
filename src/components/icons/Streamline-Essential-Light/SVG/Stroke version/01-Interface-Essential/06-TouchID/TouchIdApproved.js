...
const SvgTouchIdApproved = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".touch-id-approved_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="touch-id-approved_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="touch-id-approved_svg__a"
