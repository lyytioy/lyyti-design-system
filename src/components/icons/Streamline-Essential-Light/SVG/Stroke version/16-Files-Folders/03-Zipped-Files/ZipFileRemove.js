...
const SvgZipFileRemove = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".zip-file-remove_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="zip-file-remove_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="zip-file-remove_svg__a"
