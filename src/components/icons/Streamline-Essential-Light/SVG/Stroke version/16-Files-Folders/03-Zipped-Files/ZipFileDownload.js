...
const SvgZipFileDownload = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".zip-file-download_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
      className="zip-file-download_svg__a"
      d="M9.489 23.5H1.5a1 1 0 01-1-1v-21a1 1 0 011-1h13.293a1 1 0 01.707.293L19.207 4.5a1 1 0 01.293.707L19.489 8.5"
    />,
    <path
      className="zip-file-download_svg__a"
    ...
    />,
    <circle className="zip-file-download_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="zip-file-download_svg__a"
