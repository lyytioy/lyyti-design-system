...
const SvgFolderDownload = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".folder-download_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="folder-download_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="folder-download_svg__a"
