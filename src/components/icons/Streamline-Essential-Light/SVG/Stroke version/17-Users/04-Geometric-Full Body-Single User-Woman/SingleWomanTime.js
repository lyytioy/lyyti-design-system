...
const SvgSingleWomanTime = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".single-woman-time_svg__cls-1{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <circle
      ...
      r={6}
    />,
    <path className="single-woman-time_svg__cls-1" d="M19.5 6.7h-2V3.5" />,
    <circle className="single-woman-time_svg__cls-1" cx={6} cy={4} r={3.5} />,
    <path
      className="single-woman-time_svg__cls-1"
