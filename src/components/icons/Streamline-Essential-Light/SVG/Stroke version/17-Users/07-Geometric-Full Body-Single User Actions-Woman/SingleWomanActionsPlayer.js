...
const SvgSingleWomanActionsPlayer = (props) =>
  React.createElement(
    ...
    <path
      className="single-woman-actions-player_svg__cls-1"
      d="M15.5 17.5v-1.82a.43.43 0 01.651-.369l3.034 1.82a.43.43 0 010 .738l-3.034 1.82a.43.43 0 01-.651-.369zM2.547 4.577A4.637 4.637 0 006 2.974a4.637 4.637 0 003.453 1.6"
    />,
    <circle
      className="single-woman-actions-player_svg__cls-1"
      cx={6}
    ...
    <path
      className="single-woman-actions-player_svg__cls-1"
      d="M9.435 18.5h-.892l-1.054 5h-3l-1.054-5H.5l1.805-6.582a3.8 3.8 0 017.264-.418"
    />
  );
