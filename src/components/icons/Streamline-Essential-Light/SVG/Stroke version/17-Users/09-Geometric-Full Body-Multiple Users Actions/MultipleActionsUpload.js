...
const SvgMultipleActionsUpload = (props) =>
  React.createElement(
    ...
    <g id="multiple-actions-upload_svg___10_23" data-name="10*23">
      <path
    ...
    <g id="multiple-actions-upload_svg___10_23_-_cut" data-name="10*23 - cut">
      <g id="multiple-actions-upload_svg___Group_" data-name="&lt;Group&gt;">
        <path
          className="multiple-actions-upload_svg__cls-1"
