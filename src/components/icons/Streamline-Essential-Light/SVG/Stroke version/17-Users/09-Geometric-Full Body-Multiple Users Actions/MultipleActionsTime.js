...
const SvgMultipleActionsTime = (props) =>
  React.createElement(
    ...
    <g id="multiple-actions-time_svg___10_23" data-name="10*23">
      <path
    ...
    <g id="multiple-actions-time_svg___10_23_-_cut" data-name="10*23 - cut">
      <g id="multiple-actions-time_svg___Group_" data-name="&lt;Group&gt;">
        <path
          className="multiple-actions-time_svg__cls-1"
    ...
    <circle
      ...
      r={5}
    />,
    <path className="multiple-actions-time_svg__cls-1" d="M18.5 15.5v3h2" />
  );
