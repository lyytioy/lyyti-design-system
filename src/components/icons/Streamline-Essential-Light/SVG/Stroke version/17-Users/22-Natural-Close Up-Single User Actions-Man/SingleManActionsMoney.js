...
const SvgSingleManActionsMoney = (props) =>
  React.createElement(
    ...
    />,
    <g id="single-man-actions-money_svg___Group_" data-name="&lt;Group&gt;">
      <path
        className="single-man-actions-money_svg__cls-1"
        d="M19 14.5h-2.033a1.342 1.342 0 00-.5 2.588l2.064.825a1.342 1.342 0 01-.5 2.587H16M17.5 21.5v-.999"
      />
      <circle
        className="single-man-actions-money_svg__cls-1"
        cx={17.5}
