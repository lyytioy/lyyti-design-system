...
const SvgSingleNeutralActionsSubtract = (props) =>
  React.createElement(
    ...
    <path
      className="single-neutral-actions-subtract_svg__cls-1"
      d="M20.5 17.5h-6M9 16.5H.5a8.719 8.719 0 01.7-3.322c.49-.981 2.539-1.661 5.111-2.613.695-.258.581-2.074.273-2.413a5.127 5.127 0 01-1.34-3.978A3.354 3.354 0 018.5.5a3.354 3.354 0 013.256 3.674 5.127 5.127 0 01-1.336 3.978c-.308.339-.422 2.155.273 2.413l1.307.481"
    />
  );
