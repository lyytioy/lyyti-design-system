...
const SvgSingleWomanActionsPlayer = (props) =>
  React.createElement(
    ...
    <path
      className="single-woman-actions-player_svg__cls-1"
      d="M15.5 17.5v-1.82a.43.43 0 01.651-.369l3.034 1.82a.43.43 0 010 .738l-3.034 1.82a.43.43 0 01-.651-.369zM10.682 9.692a5.466 5.466 0 003.408-.739.484.484 0 00.128-.721c-.408-.481-.692-1.119-.817-2.967C13.162 1.74 10.785.5 8.742.5s-4.42 1.24-4.658 4.765c-.125 1.847-.409 2.486-.817 2.967a.484.484 0 00.128.721 5.467 5.467 0 003.405.739"
    />,
    <path
      className="single-woman-actions-player_svg__cls-1"
