...
const SvgSecurityLock = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".security-lock_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
      className="security-lock_svg__a"
      d="M6.5 8.5V6a5.5 5.5 0 0111 0v2.5M2.5 13.5h19M2.5 18.5h19"
    />,
    <rect
      className="security-lock_svg__a"
      x={2.5}
