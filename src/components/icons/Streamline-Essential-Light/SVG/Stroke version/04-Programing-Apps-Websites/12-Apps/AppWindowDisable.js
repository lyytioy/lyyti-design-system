...
const SvgAppWindowDisable = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".app-window-disable_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="app-window-disable_svg__a"
      d="M8.518 16.5h-6a2 2 0 01-2-2v-12a2 2 0 012-2h16a2 2 0 012 2v7"
    />,
    <circle
      className="app-window-disable_svg__a"
      cx={17.518}
