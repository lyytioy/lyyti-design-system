...
const SvgVideoFileCheck = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".video-file-check_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="video-file-check_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="video-file-check_svg__a"
