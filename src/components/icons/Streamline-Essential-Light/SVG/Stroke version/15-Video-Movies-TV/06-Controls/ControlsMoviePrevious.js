...
const SvgControlsMoviePrevious = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".controls-movie-previous_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    <circle
      ...
      r={5.5}
    />,
    <path className="controls-movie-previous_svg__a" d="M15.5 15.5v5.016" />
  );
