...
const SvgVideoEditSubtract = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".video-edit-subtract_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="video-edit-subtract_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path className="video-edit-subtract_svg__a" d="M20.5 17.5h-6" />
  );
