...
const SvgImageFileInfo = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".image-file-info_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>,
    <circle className="image-file-info_svg__a" cx={6.5} cy={7.5} r={2} />,
    <path
    ...
    />,
    <circle className="image-file-info_svg__a" cx={17.5} cy={17.5} r={6} />,
    <path
      className="image-file-info_svg__a"
