...
const SvgSmartWatchSquareUpload = (props) =>
  React.createElement(
    ...
    <path d="M12 14.5a.5.5 0 01-.5-.5v-2.793l-1.146 1.146a.5.5 0 11-.708-.707l2-2A.495.495 0 0112 9.5a.5.5 0 01.354.146l2 2A.5.5 0 0114 12.5a.5.5 0 01-.354-.146L12.5 11.207V14a.5.5 0 01-.5.5z" />
  );
