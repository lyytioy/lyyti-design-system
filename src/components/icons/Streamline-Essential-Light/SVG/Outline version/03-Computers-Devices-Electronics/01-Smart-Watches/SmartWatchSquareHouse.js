...
const SvgSmartWatchSquareHouse = (props) =>
  React.createElement(
    ...
    <path d="M8.5 17a.5.5 0 01-.5-.5v-4.688L6.836 12.87a.496.496 0 01-.706-.034.501.501 0 01.033-.706l5.5-5a.5.5 0 01.673 0l5.5 5a.5.5 0 01-.672.74L16 11.812V16.5a.5.5 0 01-.5.5h-7zm6.5-1v-5.097l-3-2.727-3 2.727V16h1v-2c0-1.103.897-2 2-2s2 .897 2 2v2h1zm-2 0v-2a1 1 0 00-2 0v2h2z" />
  );
