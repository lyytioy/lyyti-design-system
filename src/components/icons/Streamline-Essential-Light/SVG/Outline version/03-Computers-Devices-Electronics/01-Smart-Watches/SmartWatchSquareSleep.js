...
const SvgSmartWatchSquareSleep = (props) =>
  React.createElement(
    ...
    <path d="M10.768 16.5a1.26 1.26 0 01-.896-.37 1.268 1.268 0 01-.159-1.601l3.742-5.613a.267.267 0 00-.223-.416H10a.5.5 0 010-1h3.232a1.267 1.267 0 011.055 1.97l-3.742 5.614a.269.269 0 00.033.338c.051.05.117.078.188.078H14a.5.5 0 010 1h-3.232z" />
  );
