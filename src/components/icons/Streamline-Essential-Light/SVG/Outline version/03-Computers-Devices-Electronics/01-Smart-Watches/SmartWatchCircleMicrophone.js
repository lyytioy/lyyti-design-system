...
const SvgSmartWatchCircleMicrophone = (props) =>
  React.createElement(
    ...
    <path d="M12.002 17a.5.5 0 01-.5-.5v-1.535A4.008 4.008 0 018 11a.5.5 0 011 0c0 1.654 1.346 3 3 3s3-1.346 3-3a.5.5 0 011 0 4.007 4.007 0 01-3.498 3.964V16.5a.5.5 0 01-.5.5z" />
  );
