...
const SvgSwitchOff1 = (props) =>
  React.createElement(
    ...
    <path d="M9.5 18.001c-.827 0-1.5-.673-1.5-1.5v-9c0-.827.673-1.5 1.5-1.5h5c.827 0 1.5.673 1.5 1.5v9c0 .827-.673 1.5-1.5 1.5h-5zm-.5-1.5a.5.5 0 00.5.5h5a.5.5 0 00.5-.5v-2.5H9v2.5zm6-3.5v-5.5a.5.5 0 00-.5-.5h-5a.5.5 0 00-.5.5v5.5h6z" />
  );
