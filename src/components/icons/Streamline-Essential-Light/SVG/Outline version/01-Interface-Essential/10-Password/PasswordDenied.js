...
const SvgPasswordDenied = (props) =>
  React.createElement(
    ...
    <path d="M19.621 20.121a.5.5 0 01-.354-.146L17.5 18.207l-1.768 1.768a.5.5 0 11-.708-.707l1.768-1.768-1.768-1.768a.5.5 0 01.708-.707l1.768 1.768 1.768-1.768a.5.5 0 11.708.707L18.207 17.5l1.768 1.768a.5.5 0 01-.354.853zM2.5 16A2.503 2.503 0 010 13.5v-5C0 7.121 1.121 6 2.5 6h19C22.878 6 24 7.121 24 8.5V12a.5.5 0 01-1 0V8.5c0-.827-.673-1.5-1.5-1.5h-19C1.673 7 1 7.673 1 8.5v5c0 .827.673 1.5 1.5 1.5h7a.5.5 0 010 1h-7z" />
  );
