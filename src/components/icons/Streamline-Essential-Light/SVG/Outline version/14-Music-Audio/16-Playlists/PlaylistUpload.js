...
const SvgPlaylistUpload = (props) =>
  React.createElement(
    ...
    <path d="M18.5 21a.5.5 0 01-.5-.5v-2.793l-1.146 1.146a.5.5 0 11-.708-.707l2-2a.496.496 0 01.708.001l1.999 1.999a.5.5 0 11-.707.708L19 17.707V20.5a.5.5 0 01-.5.5z" />
  );
