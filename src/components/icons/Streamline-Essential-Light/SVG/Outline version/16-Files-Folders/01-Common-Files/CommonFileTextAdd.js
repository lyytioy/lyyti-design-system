...
const SvgCommonFileTextAdd = (props) =>
  React.createElement(
    ...
    <path d="M17.5 21a.5.5 0 01-.5-.5V18h-2.5a.5.5 0 010-1H17v-2.5a.5.5 0 011 0V17h2.5a.5.5 0 010 1H18v2.5a.5.5 0 01-.5.5zM4.5 9a.5.5 0 010-1H14a.5.5 0 010 1H4.5zM4.5 12a.5.5 0 010-1h6a.5.5 0 010 1h-6zM4.5 6a.5.5 0 010-1h7a.5.5 0 010 1h-7zM4.5 15a.5.5 0 010-1h4c.276 0 .5.224.5.5s-4.5.5-4.5.5zM4.5 18a.5.5 0 010-1h4a.5.5 0 010 1h-4z" />,
