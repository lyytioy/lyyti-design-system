...
const SvgUploadBox = (props) =>
  React.createElement(
    SvgIcon,
    props,
    <path d="M12 20a.5.5 0 01-.5-.5v-9.293l-4.146 4.146a.5.5 0 11-.708-.707l5-5A.495.495 0 0112 8.5a.5.5 0 01.354.146l5 5A.5.5 0 0117 14.5a.5.5 0 01-.354-.146L12.5 10.207V19.5a.5.5 0 01-.5.5z" />,
