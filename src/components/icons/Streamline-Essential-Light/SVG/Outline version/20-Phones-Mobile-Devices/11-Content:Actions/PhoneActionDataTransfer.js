...
const SvgPhoneActionDataTransfer = (props) =>
  React.createElement(
    ...
    <path d="M10.5 3a.5.5 0 010-1h3a.5.5 0 010 1h-3zM9.5 15a.492.492 0 01-.355-.148l-1.999-1.999a.5.5 0 11.708-.707L9 13.293V8.5a.5.5 0 011 0v4.793l1.146-1.146a.5.5 0 11.708.707l-2 2A.507.507 0 019.5 15zM14.5 15a.5.5 0 01-.5-.5V9.707l-1.146 1.146a.5.5 0 11-.708-.707l2-2a.502.502 0 01.708 0l2 2A.5.5 0 0116.5 11a.5.5 0 01-.354-.146L15 9.707V14.5a.5.5 0 01-.5.5z" />
  );
