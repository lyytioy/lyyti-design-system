...
const SvgPhoneActionBin = (props) =>
  React.createElement(
    ...
    <path d="M10.5 3a.5.5 0 010-1h3a.5.5 0 010 1h-3zM9.5 16a.5.5 0 01-.5-.5V11h-.5a.5.5 0 010-1h3V9a.5.5 0 011 0v1h3a.5.5 0 010 1H15v4.5a.5.5 0 01-.5.5h-5zm4.5-1v-4h-4l4 4z" />
  );
