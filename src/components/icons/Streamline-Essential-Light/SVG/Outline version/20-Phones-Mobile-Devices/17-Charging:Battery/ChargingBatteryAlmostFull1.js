...
const SvgChargingBatteryAlmostFull1 = (props) =>
  React.createElement(
    SvgIcon,
    props,
    ...
    <path d="M3 16c-.551 0-1-.448-1-1V9c0-.551.449-1 1-1h11c.552 0 1 .449 1 1v6a1 1 0 01-1 1H3zm0-1h11V9H3v6z" />
  );

export default SvgChargingBatteryAlmostFull1;
