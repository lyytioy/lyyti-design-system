...
const SvgMessagesPeopleUserQuestion = (props) =>
  React.createElement(
    SvgIcon,
    props,
    <circle cx={15.5} cy={10.893} r={0.857} />,
    <path d="M13.786 6.464a.75.75 0 00.75-.75.964.964 0 11.964.965.75.75 0 00-.75.75v1.142a.75.75 0 001.5 0v-.509a2.464 2.464 0 10-3.214-2.348.75.75 0 00.75.75z" />,
