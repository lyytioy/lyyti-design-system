...
const SvgRatingStarAdd1 = (props) =>
  React.createElement(
    ...
    <path d="M20 16.75h-1.5a.25.25 0 01-.25-.25V15a.75.75 0 10-1.5 0v1.5a.249.249 0 01-.25.25H15a.75.75 0 000 1.5h1.5a.249.249 0 01.25.25V20a.75.75 0 001.5 0v-1.5a.25.25 0 01.25-.25H20a.75.75 0 000-1.5z" />
  );
