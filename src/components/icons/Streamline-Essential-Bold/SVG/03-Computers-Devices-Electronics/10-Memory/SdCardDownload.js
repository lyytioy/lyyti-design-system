...
const SvgSdCardDownload = (props) =>
  React.createElement(
    ...
    <path d="M17.5 24a6.5 6.5 0 10-6.5-6.5 6.508 6.508 0 006.5 6.5zm-2.45-6.217a.5.5 0 01.45-.283h1a.25.25 0 00.25-.25V14.5a.75.75 0 111.5 0v2.75a.25.25 0 00.25.25h1a.5.5 0 01.391.812l-2 2.5a.519.519 0 01-.782 0l-2-2.5a.5.5 0 01-.059-.528z" />
  );
