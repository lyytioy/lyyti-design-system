...
const SvgLaptopQuestion = (props) =>
  React.createElement(
    ...
    <path d="M4.5 16.5A4.505 4.505 0 010 12a.75.75 0 01.75-.75h1.5v-9A2.252 2.252 0 014.5 0h15a2.252 2.252 0 012.25 2.25v6a.75.75 0 01-1.5 0v-6a.75.75 0 00-.75-.75h-15a.75.75 0 00-.75.75v9h6a.75.75 0 010 1.5H1.594A2.997 2.997 0 004.5 15h3.75a.75.75 0 010 1.5H4.5z" />
  );
