...
const SvgEmailActionReadDocument = (props) =>
  React.createElement(
    ...
    <path d="M8.25 6a.75.75 0 010-1.5h3a.75.75 0 010 1.5h-3zM8.25 9a.75.75 0 010-1.5h7.5a.75.75 0 010 1.5h-7.5zM8.25 12a.75.75 0 010-1.5h7.5a.75.75 0 010 1.5h-7.5z" />
  );
