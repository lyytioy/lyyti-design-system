...
const SvgCalendarRemove = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".calendar-remove_svg__a{fill:none;stroke:currentColor;stroke-linejoin:round;stroke-width:1.5px;stroke-linecap:round}"
        }
      </style>
    </defs>,
    <circle className="calendar-remove_svg__a" cx={17.25} cy={17.25} r={6} />,
    <path
