...
const SvgCogWhite = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".cog-white_svg__a{fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
      className="cog-white_svg__a"
    ...
    />,
    <circle className="cog-white_svg__a" cx={12} cy={12.001} r={4.5} />
  );

export default SvgCogWhite;
