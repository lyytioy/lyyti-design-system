...
const SvgTaskChecklistAdd = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".task-checklist-add_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
      className="task-checklist-add_svg__a"
    ...
    <path
      className="task-checklist-add_svg__a"
      d="M17.25 14.249v6M14.25 17.249h6M6.752 9.749h4.5M6.752 14.249h1.5"
    />
  );
