...
const SvgTimeClockFileDownload = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".time-clock-file-download_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <circle
    ...
    <path
      className="time-clock-file-download_svg__a"
      d="M17.25 14.25v6M17.25 20.25L15 18M17.25 20.25L19.5 18M8.25 14.25a4.5 4.5 0 114.25-5.978"
    />,
    <path
      className="time-clock-file-download_svg__a"
