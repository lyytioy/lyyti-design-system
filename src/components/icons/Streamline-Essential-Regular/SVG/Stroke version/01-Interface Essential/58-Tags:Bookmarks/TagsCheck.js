...
const SvgTagsCheck = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".tags-check_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="tags-check_svg__a" cx={16.939} cy={17.249} r={6} />,
    <path
      className="tags-check_svg__a"
      d="M19.613 15.5l-2.905 3.874a.75.75 0 01-1.13.08l-1.5-1.5"
    />
  );
