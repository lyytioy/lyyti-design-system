...
const SvgTagsAdd = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".tags-add_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="tags-add_svg__a" cx={16.939} cy={17.249} r={6} />,
    <path
      className="tags-add_svg__a"
      d="M16.939 14.999v4.5M14.689 17.249h4.5"
    />
  );
