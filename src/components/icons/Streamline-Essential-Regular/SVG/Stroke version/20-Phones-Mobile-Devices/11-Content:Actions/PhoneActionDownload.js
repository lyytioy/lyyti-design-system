...
const SvgPhoneActionDownload = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".phone-action-download_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="phone-action-download_svg__a" cx={15} cy={6.75} r={6} />,
    <path
      className="phone-action-download_svg__a"
      d="M15 3.75v6M15 9.75L12.75 7.5M15 9.75l2.25-2.25"
    />
  );
