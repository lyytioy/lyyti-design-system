...
const SvgPhoneActionsRemove = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".phone-actions-remove_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="phone-actions-remove_svg__a" cx={18} cy={6} r={5.25} />,
    <path
      className="phone-actions-remove_svg__a"
