...
const SvgPhoneRotate1 = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".phone-rotate-1_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <rect
    ...
    />,
    <path className="phone-rotate-1_svg__a" d="M6.75 17.25v4.5H1.5" />,
    <path
      className="phone-rotate-1_svg__a"
