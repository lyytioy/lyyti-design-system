...
const SvgRetouchLandscapeBlue = (props) =>
  React.createElement(
    SvgIcon,
    props,
    <defs>
      <style>
        {
          ".retouch-landscape-blue_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;color:#25abc6}"
        }
      </style>
    </defs>,
    <path
      className="retouch-landscape-blue_svg__a"
...
export default SvgRetouchLandscapeBlue;
