...
const SvgSmileyAngel = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".smiley-angel_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <circle className="smiley-angel_svg__a" cx={12} cy={12} r={11.25} />,
    <path
