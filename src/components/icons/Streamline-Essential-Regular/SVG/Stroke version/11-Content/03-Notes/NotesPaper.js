...
const SvgNotesPaper = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".notes-paper_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="notes-paper_svg__a"
      d="M14.25 23.115V15.75a1.5 1.5 0 011.5-1.5h7.365"
    />
  );
