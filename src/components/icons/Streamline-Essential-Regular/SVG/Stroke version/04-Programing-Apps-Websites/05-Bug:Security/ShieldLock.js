...
const SvgShieldLock = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".shield-lock_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="shield-lock_svg__a"
      d="M12 5.25a3 3 0 00-3 3v1.5h6v-1.5a3 3 0 00-3-3zM12 13.154a.375.375 0 11-.375.375.375.375 0 01.375-.375"
    />
  );
