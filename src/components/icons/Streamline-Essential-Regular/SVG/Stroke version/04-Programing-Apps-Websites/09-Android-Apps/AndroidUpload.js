...
const SvgAndroidUpload = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".android-upload_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="android-upload_svg__a" cx={17.25} cy={17.253} r={6} />,
    <path
      className="android-upload_svg__a"
      d="M17.25 20.253v-6M17.25 14.253L15 16.503M17.25 14.253l2.25 2.25"
    />
  );
