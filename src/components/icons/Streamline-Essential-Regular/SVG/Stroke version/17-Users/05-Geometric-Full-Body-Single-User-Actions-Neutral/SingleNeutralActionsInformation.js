...
const SvgSingleNeutralActionsInformation = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".single-neutral-actions-information_svg__cls-1{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <circle
    ...
    <path
      className="single-neutral-actions-information_svg__cls-1"
      d="M17.25 20.25v-3M17.25 14.31a.375.375 0 10.375.375.374.374 0 00-.375-.375"
    />
  );
