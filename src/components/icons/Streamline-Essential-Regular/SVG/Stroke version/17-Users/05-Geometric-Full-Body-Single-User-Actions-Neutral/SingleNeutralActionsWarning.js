...
const SvgSingleNeutralActionsWarning = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".single-neutral-actions-warning_svg__cls-1{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="single-neutral-actions-warning_svg__cls-1"
      d="M11.25 14.25v-.75a5.25 5.25 0 00-10.5 0v2.25H3l.75 7.5h4.5l.386-3.862"
    />
  );
