...
const SvgMultipleActionsHeart = (props) =>
  React.createElement(
    ...
    <path
      ...
      d="M17.25 23.25l-5.114-5.335a3.025 3.025 0 01-.567-3.492 3.026 3.026 0 014.846-.787l.835.835.835-.835a3.025 3.025 0 014.845.787 3.027 3.027 0 01-.566 3.492zM10.781 10.513A6.048 6.048 0 006.75 9a6 6 0 00-6 5.25"
    />,
    <circle
      className="multiple-actions-heart_svg__cls-1"
      cx={6.75}
