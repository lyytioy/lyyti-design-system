...
const SvgSingleWomanCheck = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".single-woman-check_svg__cls-1{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
      className="single-woman-check_svg__cls-1"
      d="M23.25 6.75a6 6 0 11-6-6M23.25 2.249l-5.47 5.47a.749.749 0 01-1.06 0L15 6"
    />,
    <circle
      className="single-woman-check_svg__cls-1"
      cx={5.25}
