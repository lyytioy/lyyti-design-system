...
const SvgMultipleActionsImage = (props) =>
  React.createElement(
    ...
    <path
      className="multiple-actions-image_svg__cls-1"
      d="M15.375 14.25a.375.375 0 11-.375.375.374.374 0 01.375-.375M23.25 21l-2.391-3.587a.749.749 0 00-1.238-.014l-2 2.851-1.236-.989a.749.749 0 00-1.092.169l-2.543 3.82"
    />,
    <circle
      className="multiple-actions-image_svg__cls-1"
      cx={6}
    ...
    <path
      className="multiple-actions-image_svg__cls-1"
      d="M9.751 9.826a5.251 5.251 0 00-9 3.674v2.25H3l.75 7.5h4.5l.387-3.862"
    />,
    <circle
      className="multiple-actions-image_svg__cls-1"
      cx={16.5}
