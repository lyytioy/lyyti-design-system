...
const SvgGamingFirstPlace = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".gaming-first-place_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    <path
      className="gaming-first-place_svg__a"
      d="M8.25 10.5H9a.75.75 0 01.75.75v5.25M8.25 16.499h3M13.5 10.5H15a1.5 1.5 0 010 3h-1.5"
    />
  );
