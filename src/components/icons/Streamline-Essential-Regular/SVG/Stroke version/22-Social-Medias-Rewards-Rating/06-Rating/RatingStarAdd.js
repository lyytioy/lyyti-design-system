...
const SvgRatingStarAdd = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".rating-star-add_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <circle className="rating-star-add_svg__a" cx={17.25} cy={17.25} r={6} />,
    <path
