...
const SvgStampsFamous = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".stamps-famous_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <path className="stamps-famous_svg__a" d="M6.75 6.75h10.5v10.5H6.75z" />,
    <path
      className="stamps-famous_svg__a"
      d="M12 6.75l-3 6h3.75v4.5M14.25 9.375a.375.375 0 10.375.375.375.375 0 00-.375-.375"
    />
  );
