...
const SvgPlaylistRemove = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".playlist-remove_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="playlist-remove_svg__a" cx={17.25} cy={17.25} r={6} />,
    <path
      className="playlist-remove_svg__a"
