...
const SvgSdCardRemove = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".sd-card-remove_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="sd-card-remove_svg__a" cx={17.25} cy={17.25} r={6} />,
    <path
      className="sd-card-remove_svg__a"
      d="M15.129 15.129l4.242 4.242M15.129 19.371l4.242-4.242"
    />
  );
