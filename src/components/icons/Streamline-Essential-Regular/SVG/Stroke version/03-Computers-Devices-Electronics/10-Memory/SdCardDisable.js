...
const SvgSdCardDisable = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".sd-card-disable_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="sd-card-disable_svg__a" cx={17.25} cy={17.25} r={6} />,
    <path className="sd-card-disable_svg__a" d="M13.007 21.493l8.486-8.486" />
  );
