...
const SvgCommonFileSearch = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".common-file-search_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    <circle
      ...
      r={5.25}
    />,
    <path className="common-file-search_svg__a" d="M23.25 23.25l-3.774-3.788" />
  );
