...
const SvgFolderAdd = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".folder-add_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="folder-add_svg__a" cx={17.25} cy={17.25} r={6} />,
    <path className="folder-add_svg__a" d="M17.25 14.25v6M14.25 17.25h6" />
  );
