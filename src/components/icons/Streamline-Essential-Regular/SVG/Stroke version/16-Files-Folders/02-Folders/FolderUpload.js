...
const SvgFolderUpload = (props) =>
  React.createElement(
    ...
    <defs>
      <style>
        {
          ".folder-upload_svg__a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}"
        }
      </style>
    </defs>,
    <path
    ...
    />,
    <circle className="folder-upload_svg__a" cx={17.25} cy={17.25} r={6} />,
    <path
      className="folder-upload_svg__a"
